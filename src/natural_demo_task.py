...
from visualize import save_image, save_zone_map, save_panel, save_heatmap
...
def run():
    ...
    for idx, path in enumerate(files):
        ...
        save_heatmap(os.path.join(img_dir, f'{name}_delta.png'), delta_map, cmap='coolwarm')
